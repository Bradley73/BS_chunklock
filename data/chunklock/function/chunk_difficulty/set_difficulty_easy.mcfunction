...
execute unless score #global ChunklockDifficulty matches 1 run function chunklock:utils/reset

tellraw @a [{"text": "The ", "color": "white", "bold": true}, {"text": "Chunklock", "color": "gold", "bold": true}, {"text": " difficulty has been set to ",  "color": "white","bold": true}, {"text": "Easy", "color": "white", "bold": true}, {"text": ".",  "color": "white","bold": true}]
scoreboard players set #global ChunklockDifficulty 1
