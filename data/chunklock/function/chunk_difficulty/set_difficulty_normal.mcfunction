...
execute unless score #global ChunklockDifficulty matches 2 run function chunklock:utils/reset

tellraw @a [{"text": "The ", "color": "white", "bold": true}, {"text": "Chunklock", "color": "gold", "bold": true}, {"text": " difficulty has been set to ",  "color": "white","bold": true}, {"text": "Normal", "color": "aqua", "bold": true}, {"text": ".",  "color": "white","bold": true}]
scoreboard players set #global ChunklockDifficulty 2
